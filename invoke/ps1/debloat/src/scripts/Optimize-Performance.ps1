...
function Optimize-Performance() {
    ...
    # Removido a desativação das atualizações automáticas da Microsoft Store
    ...
    # Removido a desativação do Xbox Game Bar e DVR
    # If (!$Revert) {
    ...
    # Removido a ativação do Game Mode (deixar como está no sistema)
