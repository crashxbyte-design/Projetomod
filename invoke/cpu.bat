cls
:: Configura o valor máximo de desempenho da CPU para 100%
...
:: Configura o valor máximo de desempenho da CPU para 100% no esquema de alto desempenho
...
:: Desativa configurações de economia de energia para a CPU (ValueMin e ValueMax definidos como 0)
...
:: Repete as configurações para ControlSet001 e ControlSet002 (backups do registro)
