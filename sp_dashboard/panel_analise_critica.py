...
from styles import VERMELHO, VERMELHO_ESC, BRANCO, CINZA_BG, CINZA_BORDA, CINZA_SUAVE, PRETO_TITULO, VERDE, LARANJA, COMBO_DROPDOWN_CSS
...
def _cbx(items=None, editable=False):
    ...
    w.setStyleSheet(f"QComboBox{{{CSS_FIELD}}}{COMBO_DROPDOWN_CSS}QComboBox:focus{{border:1.5px solid {VERMELHO_ESC};background:#FFFFFF;}}")
    return w
